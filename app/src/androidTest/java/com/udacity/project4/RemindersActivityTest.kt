 ...
 *  VERY IMPORTANT:
 *  To reduce Flakiness in Automated UI Testing, always remember to disable Animations.
 *  This has been set under build.gradle but just in case.
 */
class RemindersActivityTest :
    ...
    // get activity context - got this from a mentor in the course discussion group
    ...
    @Test
    fun addReminder_showReminderSaved() = runBlocking {
    ...
    @Test
    fun loggedInAddReminderWithoutLocation_errorSelectLocation() = runBlocking {
        val reminder = ReminderDTO(
            "Reminder Title A",
            "Reminder Description A",
            "Location",
        ...
        // Expects snackbar showing Please select location
